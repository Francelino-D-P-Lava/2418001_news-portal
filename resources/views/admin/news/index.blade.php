...
<body>
    ...
    <div class="main-content">
        <div class="content-card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-newspaper me-2"></i> Manajemen Berita</h5>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($item->image)
                                    <img src="{{ asset('storage/' . $item->image) }}" width="40" height="40" style="object-fit: cover; border-radius: 8px;">
                                @else
                            ...
                            <td>
                                <a href="{{ route('admin.news.show', $item->id) }}" class="btn-show">Lihat</a>
    ...
    <script>
        function confirmDelete(id) {
            Swal.fire({
                title: 'Yakin hapus?',
                text: "Berita tidak bisa dikembalikan!",
                icon: 'warning',
